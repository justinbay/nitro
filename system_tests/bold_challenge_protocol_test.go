...
import (
	...
	"github.com/offchainlabs/nitro/bold/challenge/testing"
...
func deployContractsOnly(
	...
	cfg := testing.GenerateRollupConfig(
		false,
		wasmModuleRoot,
		...
		testing.WithLayerZeroHeights(&protocol.LayerZeroHeights{
		...
		testing.WithNumBigStepLevels(uint8(3)),       // TODO: Hardcoded.
		testing.WithConfirmPeriodBlocks(uint64(120)), // TODO: Hardcoded.
	)
	...
	addresses, err := setup.DeployFullRollupStack(
		ctx,
		backend.NewBackendWrapper(backend, rpc.LatestBlockNumber),
		&l1TransactionOpts,
